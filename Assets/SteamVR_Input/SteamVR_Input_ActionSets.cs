...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_weapons p_weapons;
        ...
        public static SteamVR_Input_ActionSet_weapons weapons
        {
            get
            {
                return SteamVR_Actions.p_weapons.GetCopy<SteamVR_Input_ActionSet_weapons>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_weapons = ((SteamVR_Input_ActionSet_weapons)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_weapons>("/actions/weapons")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.weapons};
        }
    }
}
